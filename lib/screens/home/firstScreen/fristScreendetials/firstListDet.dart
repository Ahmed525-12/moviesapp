...
import 'package:moviesapp/screens/home/firstScreen/fristScreendetials/similar.dart';

import '../../../../apis/api_manager.dart';
import '../../../../models/popular.dart';
import '../../../../models/smiliar_movie.dart';

class FirstdetList extends StatelessWidget {
  const FirstdetList({Key? key}) : super(key: key);
  static const String routeName = "firstdet";
  @override
  Widget build(BuildContext context) {
    ResultsPopular results = ModalRoute.of(context)!.settings.arguments as ResultsPopular;
    return Scaffold(
      appBar: AppBar(
        title: Text(
          "${results.title}",
                 ...
                 child: FutureBuilder<SmiliarMovie>(
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Similar(resultList[index]);
                    },
