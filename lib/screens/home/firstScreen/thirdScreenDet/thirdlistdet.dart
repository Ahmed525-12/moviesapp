...
import 'package:moviesapp/screens/home/firstScreen/thirdScreenDet/similarthird.dart';

import '../../../../apis/api_manager.dart';
import '../../../../models/smiliar_movie.dart';
import '../../../../models/top_rated.dart';

class ThirdListDet extends StatelessWidget {
  const ThirdListDet({Key? key}) : super(key: key);
 static const String routeName = "third det";
  @override
  Widget build(BuildContext context) {
        ResultsTR results = ModalRoute.of(context)!.settings.arguments as ResultsTR;
                 ...
                 child: FutureBuilder<SmiliarMovie>(
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return SimilarThird(resultList[index]);
                    },
