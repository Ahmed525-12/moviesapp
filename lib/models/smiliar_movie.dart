...
class SmiliarMovie {
  int? page;
  List<ResultsSmiliar>? results;
  int? totalPages;
  int? totalResults;
  int? status_code;
  String? status_message;
  bool? success;
  SmiliarMovie({this.page, this.results, this.totalPages, this.totalResults});

  SmiliarMovie.fromJson(Map<String, dynamic> json) {
    ...
    if (json["results"] is List) {
      results = json["results"] == null
          ? null
          : (json["results"] as List).map((e) => ResultsSmiliar.fromJson(e)).toList();
    }
...
class ResultsSmiliar {
  ...
  ResultsSmiliar.fromJson(Map<String, dynamic> json) {
